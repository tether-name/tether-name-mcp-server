...
This server wraps the [`tether-name`](https://www.npmjs.com/package/tether-name) SDK, letting any MCP-compatible AI agent verify its identity through Tether without writing integration code.
